...
public class Decimal implements Comparable<Decimal> {
     ...
     * 大于
     */
    public boolean gt(Decimal target) {
        return this.data.compareTo(target.data) > 0;
    }

    /**
     * 等于
     */
    public boolean eq(Decimal target) {
        return this.data.compareTo(target.data) == 0;
    }
     ...
     * 小于
     */
    public boolean lt(Decimal target) {
        return this.data.compareTo(target.data) < 0;
    }
     ...
     * 大于等于
     */
    public boolean ge(Decimal target) {
        return this.data.compareTo(target.data) >= 0;
    }
     ...
     * 小于等于
     */
    public boolean le(Decimal target) {
        return this.data.compareTo(target.data) <= 0;
    }
    @Override
